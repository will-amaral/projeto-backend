...
async function mail(email, token, recover) {
    ...
    // e passamos como parâmetro de middleware
    ...
    // Finalmente, enviamos o e-mail com todos as informações
    // definidas anteriormente. Como a função de envio retorna
    // os dados de envio (como erros), armazenamos em uma variável
...
// Exporta a função que gera o token com o id do usuário
// e envia para o email do mesmo, com a função mail.
// Exportamos a função diretamente para conveniência
